...
LoadData DefaultLoader::loadModel(const std::string_view& path)
{
...
void DefaultLoader::processNode(aiNode* node, const aiScene* scene)
{
...
Mesh* DefaultLoader::processMesh(aiMesh* mesh, const aiScene* scene)
{
...
std::vector<Texture> DefaultLoader::loadMaterialTextures(aiMaterial* mat, aiTextureType type,
